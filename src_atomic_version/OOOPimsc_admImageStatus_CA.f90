...
USE, INTRINSIC :: iso_fortran_env ! 160904
!___________________________________________________________
...
! access routines for scalar
! and static array members:
PUBLIC :: OOOPimsc_SYNC_MEMORY_CA
PUBLIC :: OOOPimscS_intImageActivityFlag_CA, OOOPimscG_intImageActivityFlag_CA, &
          OOOPimscS_atomic_intImageActivityFlag_CA, OOOPimscG_atomic_intImageActivityFlag_CA, & ! 160904
...
TYPE, PUBLIC :: OOOPimsc_adtImageStatus_CA
  PRIVATE
  !*****
  INTEGER(atomic_int_kind) :: m_atomic_intImageActivityFlag = OOOPimscEnum_ImageActivityFlag % InitialWaiting ! 160904
  !*****
...
SUBROUTINE OOOPimscS_intImageActivityFlag_CA (Object_CA, intImageActivityFlag, &
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                ...
                                                                END IF
                                                                !
  Object_CA[intImageNumber] % m_atomic_intImageActivityFlag = intImageActivityFlag
                                                                CALL OOOGglob_subResetProcedures
...
SUBROUTINE OOOPimscG_intImageActivityFlag_CA (Object_CA, intImageActivityFlag, &
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                ...
                                                                END IF
                                                                !
  intImageActivityFlag = Object_CA[intImageNumber] % m_atomic_intImageActivityFlag
                                                                CALL OOOGglob_subResetProcedures
...
!  USE, INTRINSIC :: iso_fortran_env
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                ...
                                                                !
  SYNC MEMORY ! 160904
  CALL ATOMIC_DEFINE(Object_CA[intImageNumber] % m_atomic_intImageActivityFlag, intImageActivityFlag) ! 160904
  !
                                                                CALL OOOGglob_subResetProcedures
END SUBROUTINE OOOPimscS_atomic_intImageActivityFlag_CA
!**********
SUBROUTINE OOOPimscG_atomic_intImageActivityFlag_CA (Object_CA, intImageActivityFlag)
!  USE, INTRINSIC :: iso_fortran_env
  TYPE (OOOPimsc_adtImageStatus_CA), CODIMENSION[*], INTENT (INOUT) :: Object_CA
  INTEGER(OOOGglob_kint), INTENT (OUT) :: intImageActivityFlag
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
  ...
  !
  CALL ATOMIC_REF(intImageActivityFlag, Object_CA % m_atomic_intImageActivityFlag) ! 160904
  !
                                                                CALL OOOGglob_subResetProcedures
END SUBROUTINE OOOPimscG_atomic_intImageActivityFlag_CA
!***********
SUBROUTINE OOOPimsc_SYNC_MEMORY_CA
!  USE, INTRINSIC :: iso_fortran_env
                                                                CALL OOOGglob_subSetProcedures &
                                                                 ("OOOPimsc_SYNC_MEMORY_CA")
  !
  SYNC MEMORY
  !
                                                                CALL OOOGglob_subResetProcedures
END SUBROUTINE OOOPimsc_SYNC_MEMORY_CA
!***********
